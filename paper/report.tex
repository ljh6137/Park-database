...
\subsubsection*{1.1 客户表（Customer）}
...
\subsubsection*{1.3 车辆库表（Repository）}
\begin{tabular}{|l|l|l|l|}
\hline
字段名 & 数据类型 & 约束 & 说明 \\
\hline
